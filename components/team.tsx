...
const Team = () => {
  ...
  return (
    <section className="py-24 bg-[#FFF8F0] dark:bg-[#001514] min-h-screen flex flex-col items-center justify-center overflow-hidden transition-colors duration-300">
      ...
      {/* INFINITE VIRTUAL SLIDER - Wrapped in 3D Perspective Reveal */}
      <PerspectiveIn delay={0.2} fullWidth className="flex justify-center">
      ...
      {/* STYLISH INDICATORS - Fade In Last */}
